...
using StudentManagement.UI.Functions.StudentsFunc; // Giả sử StudentsAdding/EditingWindow nằm ở đây
using System;
...
namespace StudentManagement.UI.Pages
{
    ...
    public partial class StudentsPage : UserControl
    {
        ...
        private void BtnAdding_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (mainWindow != null)
            {
                // Giả sử bạn đã có cửa sổ StudentsAddingWindow
                // Bạn sẽ cần cập nhật cửa sổ này để làm việc với Student class mới
        ...
        // Bạn có thể xóa các event handler không dùng đến này
        private void StudentsDataGrid_SelectionChanged(object sender, SelectionChangedEventArgs e) { }
        private void StudentsDataGrid_SelectionChanged_1(object sender, SelectionChangedEventArgs e) { }
